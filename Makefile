...
all: bin/binary.o bin/golay.o bin/fourier.o bin/orderly_equivalence.o bin/equivalence.o bin/array.o bin/generate_hybrid bin/cache_filter bin/canon_filter bin/match_pairs bin/uncompression bin/compress bin/PAPR
...
$(BIN)generate_hybrid: $(SRC)generate_hybrid.cpp $(BIN)golay.o $(BIN)array.o $(BIN)fourier.o $(BIN)orderly_equivalence.o $(BIN)binary.o
	$(CC) -Wall -g -O3 $(SRC)generate_hybrid.cpp $(BIN)orderly_equivalence.o $(BIN)array.o $(BIN)fourier.o $(BIN)golay.o $(BIN)binary.o -o $(BIN)generate_hybrid $(FFTW) -fopenmp
